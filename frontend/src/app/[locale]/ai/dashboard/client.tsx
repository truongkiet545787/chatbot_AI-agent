			...
			<Container className='flex shrink-0 grow basis-auto flex-col pb-0'>
				<AIChatContainerCommon>
					<div className='col-span-12 my-12 flex flex-col items-center justify-center text-center'>
						...
						{/* Thanh nhập liệu trung tâm nổi bật */}
						<div className='w-full max-w-2xl mt-8 mb-4 relative flex items-center bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl focus-within:border-indigo-500/80 focus-within:ring-2 focus-within:ring-indigo-500/10 focus-within:shadow-indigo-500/5 transition-all duration-300 p-2 shadow-lg'>
							{/* Icon search/sparkles */}
							<div className='p-2.5 text-zinc-400 dark:text-zinc-500 shrink-0'>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<Link
							...
							<div className='group relative rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-lg hover:border-emerald-500/30 dark:hover:border-emerald-500/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden'>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<Link
							...
							<div className='group relative rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-lg hover:border-amber-500/30 dark:hover:border-amber-500/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden'>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<Link
							...
							<div className='group relative rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-lg hover:border-rose-500/30 dark:hover:border-rose-500/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden'>
								...
								<div className='flex items-center gap-4 relative z-10'>
									...
									<div className='grow'>
										<div className='text-lg font-bold text-zinc-800 dark:text-zinc-100 group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors duration-200'>
											Bản phác thảo
										</div>
										<div className='text-xs text-zinc-400 dark:text-zinc-500 mt-1'>
											Tạo ảnh từ nét vẽ phác thảo
										</div>
									</div>
								</div>
							</div>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<Link
							...
							<div className='group relative rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-lg hover:border-violet-500/30 dark:hover:border-violet-500/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden'>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<Link
							...
							<div className='group relative rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-lg hover:border-blue-500/30 dark:hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden'>
